...
public class DeportesMadridConstants {
    public static final String URL_MATCHES = "https://datos.madrid.es/egob/catalogo/300169-3-juegos-deportivos-actual.csv";
    public static final String URL_CLASSIFICATION = "https://datos.madrid.es/egob/catalogo/300169-1-juegos-deportivos-actual.csv";
    ...
    public static final String BUCKET_CLASSIFICATION = "deportes_madrid_classification_2017";
    public static final String BUCKET_MATCHES= "deportes_madrid_matches_2017";
    ...
    public static final String PARAMETER_URL_MATCHES = "PARAMETER_URL_MATCHES";
    public static final String PARAMETER_URL_CLASSIFICATION = "PARAMETER_URL_CLASSIFICATION";
