...
public class DeportesMadridConstants {
    ...
    public static final String BUCKET_CLASSIFICATION = "deportes_madrid_classification_2019";
    public static final String BUCKET_MATCHES= "deportes_madrid_matches_2019";
